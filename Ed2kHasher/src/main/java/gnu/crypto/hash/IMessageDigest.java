...
/**
 * <p>
 * The basic visible methods of any hash algorithm.</p>
 *
 * <p>
 * A hash (or message digest) algorithm produces its output by iterating a basic
 * compression function on blocks of data.</p>
 *
...
public interface IMessageDigest extends Cloneable {
   ...
   // Constants
    ...
    /**
     * <p>
     * Returns the algorithm's (inner) block size in bytes.</p>
     *
     ...
     * equal to a known pre-computed value.</p>
     *
